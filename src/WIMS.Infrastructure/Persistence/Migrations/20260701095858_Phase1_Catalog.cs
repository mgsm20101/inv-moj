...
{
    /// <inheritdoc />
    public partial class Phase1_Catalog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeeperUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<byte>(type: "tinyint", nullable: false),
                    AllowNegativeStock = table.Column<bool>(type: "bit", nullable: false),
                    UsesLocations = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TracksBatch = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    MaxStock = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: true),
                    ReorderPoint = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                    ReorderQty = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: true),
                    WeightedAvgCost = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    LastPurchaseCost = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: true),
                    HazardClass = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    StorageConditions = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Items_UnitsOfMeasure_BaseUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QtyReserved = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                    QtyAvailable = table.Column<decimal>(type: "decimal(18,3)", nullable: false, computedColumnSql: "[QtyOnHand] - [QtyReserved]", stored: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockBalances_ItemId_WarehouseId_LocationId_BatchNo_SerialNo",
                table: "StockBalances",
                columns: new[] { "ItemId", "WarehouseId", "LocationId", "BatchNo", "SerialNo" },
                unique: true,
                filter: "[LocationId] IS NOT NULL AND [BatchNo] IS NOT NULL AND [SerialNo] IS NOT NULL");
